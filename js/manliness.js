...
let supportText = "Пожертвовать средства на поддержку и развития проекта" +
    "вы можете переводом на кошелёк Qiwi или на карту через СПБ по номеру телефона:" +
    "<br>" +
    "+79920236495" +
    "<br>" +
    "<br>" +
    "Также вы можете перевести средства на биткойн-кошелёк:" +
    "<br>" +
    "bc1qtx49fwx8ut4tf0p7u4tlz6ks4t6uw9pmj89ky7"
